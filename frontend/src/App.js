...
function App() {
  ...
  const onPictureSubmit = () => {
    ...
    fetch(`${API_URL}/image-url`, {                            // fetch does not directly return the JSON response body, instead it returns a promise whose fulfill value is a Response object
      method: 'post',
      ...
      .then(responseBody => {
        ...
        fetch(`${API_URL}/image-count`, {                    // This was added when connecting the frontend to the backend. // Note: fetch does not directly return the JSON response body, instead it returns a promise whose fulfill value is a Response object
          method: 'put',
